...
def filter_classes(all_data, clean_cls_idx, classes_type):
    ...
    final_all_data_filtered = {k: v for k, v in all_data_filtered.items() if v[0] is not None and v[1] is not None}
...
def parse_args():
    ...
    parser.add_argument('--results_clean', type=str, default='./knn_euclidean_distance_nn10_feat_cleaned.json', help='File with results about noisy features.')
    parser.add_argument('--results_noisy', type=str, default='./knn_euclidean_distance_nn10_feat_noisy.json', help='File with results about noisy features.')
...
if __name__ == "__main__":
    ...
    if os.path.exists(args.comparison_file):
        ...
        visualize_tsne(data_clean, noisy_cls_idx, clean_cls_idx, args.classes, args.output_folder)
        visualize_tsne(data_noisy, noisy_cls_idx, clean_cls_idx, args.classes, args.output_folder)
    else:
