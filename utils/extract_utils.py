...
def save_roi_features_detectron2(args, cfg, im_file, im, dataset_dict, boxes, scores, features_pooled, attr_scores=None):
    ...
    output_file = os.path.join(args.output_dir, im_file.split('/')[-1].split('.')[0])
