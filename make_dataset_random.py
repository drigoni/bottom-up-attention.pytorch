...
def save_dataset(annotations_file, annotations):
    ...
    output_folder = "datasets/random_visual_genome/annotations"
    if not os.path.exists(output_folder):
        os.makedirs(output_folder)
    output_file = "{}/random_{}".format(output_folder, output_file_name)
...
def parse_args():
    ...
    parser.add_argument('--labels', dest='labels',
                        ...
                        default="./evaluation/objects_vocab_random.txt",
                        type=str)
